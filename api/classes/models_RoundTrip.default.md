[@entur-partner/products-models](../README.md) / [models/RoundTrip](../modules/models_RoundTrip.md) / default

# Class: default

[models/RoundTrip](../modules/models_RoundTrip.md).default
...
• **new default**(`data?`): [`default`](models_RoundTrip.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`RoundTripData`](../interfaces/types_interfaces.RoundTripData.md)\> |
...
[src/models/RoundTrip.ts:15](https://github.com/entur/products-models/blob/main/src/models/RoundTrip.ts#L15)
...
[src/models/RoundTrip.ts:10](https://github.com/entur/products-models/blob/main/src/models/RoundTrip.ts#L10)
...
[src/models/RoundTrip.ts:12](https://github.com/entur/products-models/blob/main/src/models/RoundTrip.ts#L12)
...
[src/models/RoundTrip.ts:11](https://github.com/entur/products-models/blob/main/src/models/RoundTrip.ts#L11)
...
• `Optional` **tripType**: [`TripType`](../enums/types_enums.TripType.md)

#### Defined in

[src/models/RoundTrip.ts:9](https://github.com/entur/products-models/blob/main/src/models/RoundTrip.ts#L9)
...
[src/models/RoundTrip.ts:13](https://github.com/entur/products-models/blob/main/src/models/RoundTrip.ts#L13)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_RoundTrip.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_RoundTrip.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_RoundTrip.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_RoundTrip.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_RoundTrip.default.md) |
| `values` | `Object` |
...
[src/models/RoundTrip.ts:25](https://github.com/entur/products-models/blob/main/src/models/RoundTrip.ts#L25)
