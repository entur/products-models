[@entur-partner/products-models](../README.md) / [models/TypeOfUsageParameter](../modules/models_TypeOfUsageParameter.md) / default

# Class: default

[models/TypeOfUsageParameter](../modules/models_TypeOfUsageParameter.md).default
...
• **new default**(`data?`): [`default`](models_TypeOfUsageParameter.default.md)
...
[src/models/TypeOfUsageParameter.ts:6](https://github.com/entur/products-models/blob/main/src/models/TypeOfUsageParameter.ts#L6)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_TypeOfUsageParameter.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_TypeOfUsageParameter.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_TypeOfUsageParameter.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_TypeOfUsageParameter.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_TypeOfUsageParameter.default.md) |
| `values` | `Object` |
...
[src/models/TypeOfUsageParameter.ts:10](https://github.com/entur/products-models/blob/main/src/models/TypeOfUsageParameter.ts#L10)
