[@entur-partner/products-models](../README.md) / [models/Transferability](../modules/models_Transferability.md) / default

# Class: default

[models/Transferability](../modules/models_Transferability.md).default
...
• **new default**(`data?`): [`default`](models_Transferability.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`TransferabilityData`](../interfaces/types_interfaces.TransferabilityData.md)\> |
...
[src/models/Transferability.ts:12](https://github.com/entur/products-models/blob/main/src/models/Transferability.ts#L12)
...
[src/models/Transferability.ts:8](https://github.com/entur/products-models/blob/main/src/models/Transferability.ts#L8)
...
• `Optional` **hasTransferFee**: `boolean`

#### Defined in

[src/models/Transferability.ts:10](https://github.com/entur/products-models/blob/main/src/models/Transferability.ts#L10)
...
• `Optional` **maximumNumberOfNamedUsers**: `number`

#### Defined in

[src/models/Transferability.ts:9](https://github.com/entur/products-models/blob/main/src/models/Transferability.ts#L9)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_Transferability.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_Transferability.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_Transferability.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_Transferability.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_Transferability.default.md) |
| `values` | `Object` |
...
[src/models/Transferability.ts:21](https://github.com/entur/products-models/blob/main/src/models/Transferability.ts#L21)
