[@entur-partner/products-models](../README.md) / [models/EntitlementGiven](../modules/models_EntitlementGiven.md) / default

# Class: default

[models/EntitlementGiven](../modules/models_EntitlementGiven.md).default
...
• **new default**(`data?`): [`default`](models_EntitlementGiven.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`EntitlementGivenData`](../interfaces/types_interfaces.EntitlementGivenData.md)\> |
...
[src/models/EntitlementGiven.ts:16](https://github.com/entur/products-models/blob/main/src/models/EntitlementGiven.ts#L16)
...
• **entitlementType**: [`EntitlementType`](../enums/types_enums.EntitlementType.md)

#### Defined in

[src/models/EntitlementGiven.ts:12](https://github.com/entur/products-models/blob/main/src/models/EntitlementGiven.ts#L12)
...
[src/models/EntitlementGiven.ts:14](https://github.com/entur/products-models/blob/main/src/models/EntitlementGiven.ts#L14)
...
[src/models/EntitlementGiven.ts:15](https://github.com/entur/products-models/blob/main/src/models/EntitlementGiven.ts#L15)

___

### serviceAccessRightRef

• `Optional` **serviceAccessRightRef**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/EntitlementGiven.ts:13](https://github.com/entur/products-models/blob/main/src/models/EntitlementGiven.ts#L13)
...
[src/models/EntitlementGiven.ts:30](https://github.com/entur/products-models/blob/main/src/models/EntitlementGiven.ts#L30)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_EntitlementGiven.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_EntitlementGiven.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_EntitlementGiven.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_EntitlementGiven.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_EntitlementGiven.default.md) |
| `values` | `Object` |
...
[src/models/EntitlementGiven.ts:26](https://github.com/entur/products-models/blob/main/src/models/EntitlementGiven.ts#L26)
