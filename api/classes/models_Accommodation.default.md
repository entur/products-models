[@entur-partner/products-models](../README.md) / [models/Accommodation](../modules/models_Accommodation.md) / default

# Class: default

[models/Accommodation](../modules/models_Accommodation.md).default
...
• **new default**(`data`): [`default`](models_Accommodation.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`AccomodationData`](../interfaces/types_interfaces.AccomodationData.md)\> |
...
[src/models/Accommodation.ts:13](https://github.com/entur/products-models/blob/main/src/models/Accommodation.ts#L13)

## Properties

### accommodationFacility

• `Optional` **accommodationFacility**: [`AccommodationFacility`](../enums/types_enums.AccommodationFacility.md)

#### Defined in

[src/models/Accommodation.ts:10](https://github.com/entur/products-models/blob/main/src/models/Accommodation.ts#L10)
...
• `Optional` **nuisanceFacilities**: [`NuisanceFacility`](../enums/types_enums.NuisanceFacility.md)[]

#### Defined in

[src/models/Accommodation.ts:11](https://github.com/entur/products-models/blob/main/src/models/Accommodation.ts#L11)
...
[src/models/Accommodation.ts:19](https://github.com/entur/products-models/blob/main/src/models/Accommodation.ts#L19)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_Accommodation.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_Accommodation.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_Accommodation.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_Accommodation.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_Accommodation.default.md) |
| `values` | `Object` |
