[@entur-partner/products-models](../README.md) / [models/FareFrame](../modules/models_FareFrame.md) / default

# Class: default

[models/FareFrame](../modules/models_FareFrame.md).default
...
• **new default**(`data?`): [`default`](models_FareFrame.default.md)
...
[src/models/FareFrame.ts:8](https://github.com/entur/products-models/blob/main/src/models/FareFrame.ts#L8)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_FareFrame.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_FareFrame.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_FareFrame.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_FareFrame.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_FareFrame.default.md) |
| `values` | `Object` |
...
[src/models/FareFrame.ts:16](https://github.com/entur/products-models/blob/main/src/models/FareFrame.ts#L16)
