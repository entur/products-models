[@entur-partner/products-models](../README.md) / [models/ChargingMoment](../modules/models_ChargingMoment.md) / default

# Class: default

[models/ChargingMoment](../modules/models_ChargingMoment.md).default
...
• **new default**(`data?`): [`default`](models_ChargingMoment.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`ChargingMomentData`](../interfaces/types_interfaces.ChargingMomentData.md)\> |
...
[src/models/ChargingMoment.ts:13](https://github.com/entur/products-models/blob/main/src/models/ChargingMoment.ts#L13)
...
[src/models/ChargingMoment.ts:11](https://github.com/entur/products-models/blob/main/src/models/ChargingMoment.ts#L11)
...
[src/models/ChargingMoment.ts:10](https://github.com/entur/products-models/blob/main/src/models/ChargingMoment.ts#L10)
...
[src/models/ChargingMoment.ts:9](https://github.com/entur/products-models/blob/main/src/models/ChargingMoment.ts#L9)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_ChargingMoment.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_ChargingMoment.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_ChargingMoment.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_ChargingMoment.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_ChargingMoment.default.md) |
| `values` | `Object` |
...
[src/models/ChargingMoment.ts:33](https://github.com/entur/products-models/blob/main/src/models/ChargingMoment.ts#L33)
