...
▸ **addValidableElement**(`validableElement`): [`default`](models_CappedDiscountRight.default.md)
...
▸ **changeOrderOfAccessRightsInProduct**(`accessRightInProduct`, `accessNumber`): [`default`](models_CappedDiscountRight.default.md)
