...
src/models/JourneyPattern.ts:11
...
src/models/JourneyPattern.ts:9
...
src/models/JourneyPattern.ts:34
...
src/models/JourneyPattern.ts:23
...
▸ **updateRefs**(`bucket`): [`default`](models_JourneyPattern.default.md)
...
src/models/JourneyPattern.ts:19
