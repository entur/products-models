[@entur-partner/products-models](../README.md) / [models/FrequencyOfUse](../modules/models_FrequencyOfUse.md) / default

# Class: default

[models/FrequencyOfUse](../modules/models_FrequencyOfUse.md).default
...
• **new default**(`data?`): [`default`](models_FrequencyOfUse.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`FrequencyOfUseData`](../interfaces/types_interfaces.FrequencyOfUseData.md)\> |
...
[src/models/FrequencyOfUse.ts:15](https://github.com/entur/products-models/blob/main/src/models/FrequencyOfUse.ts#L15)
...
[src/models/FrequencyOfUse.ts:11](https://github.com/entur/products-models/blob/main/src/models/FrequencyOfUse.ts#L11)
...
• `Optional` **maximalFrequency**: `number`

#### Defined in

[src/models/FrequencyOfUse.ts:12](https://github.com/entur/products-models/blob/main/src/models/FrequencyOfUse.ts#L12)

___

### minimalFrequency

• `Optional` **minimalFrequency**: `number`

#### Defined in

[src/models/FrequencyOfUse.ts:13](https://github.com/entur/products-models/blob/main/src/models/FrequencyOfUse.ts#L13)
...
[src/models/FrequencyOfUse.ts:37](https://github.com/entur/products-models/blob/main/src/models/FrequencyOfUse.ts#L37)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_FrequencyOfUse.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_FrequencyOfUse.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_FrequencyOfUse.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_FrequencyOfUse.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_FrequencyOfUse.default.md) |
| `values` | `Object` |
...
[src/models/FrequencyOfUse.ts:33](https://github.com/entur/products-models/blob/main/src/models/FrequencyOfUse.ts#L33)
