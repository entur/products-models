[@entur/products-models](../README.md) / [models/FulfilmentMethod](../modules/models_FulfilmentMethod.md) / default

# Class: default

[models/FulfilmentMethod](../modules/models_FulfilmentMethod.md).default
...
• **new default**(`data?`): [`default`](models_FulfilmentMethod.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`FulfilmentMethodData`](../interfaces/types_interfaces.FulfilmentMethodData.md)\> |

#### Returns

[`default`](models_FulfilmentMethod.default.md)
...
[src/models/FulfilmentMethod.ts:11](https://github.com/entur/products-models/blob/main/src/models/FulfilmentMethod.ts#L11)
...
• `Optional` **fulfilmentMethodType**: [`FulfilmentMethodType`](../enums/types_enums.FulfilmentMethodType.md)

#### Defined in

[src/models/FulfilmentMethod.ts:9](https://github.com/entur/products-models/blob/main/src/models/FulfilmentMethod.ts#L9)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_FulfilmentMethod.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_FulfilmentMethod.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_FulfilmentMethod.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_FulfilmentMethod.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_FulfilmentMethod.default.md) |
| `values` | `Object` |
...
[src/models/FulfilmentMethod.ts:17](https://github.com/entur/products-models/blob/main/src/models/FulfilmentMethod.ts#L17)
