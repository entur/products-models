[@entur-partner/products-models](../README.md) / [models/UserProfile](../modules/models_UserProfile.md) / default

# Class: default

[models/UserProfile](../modules/models_UserProfile.md).default
...
• **new default**(`data?`): [`default`](models_UserProfile.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`UserProfileData`](../interfaces/types_interfaces.UserProfileData.md)\> |
...
• `Optional` **baseUserProfileRef**: `string`
...
• **companionProfiles**: [`default`](models_CompanionProfile.default.md)[]
...
• `Optional` **proofOfIdentity**: [`ProofOfIdentity`](../enums/types_enums.ProofOfIdentity.md)
...
• `Optional` **typeOfConcessionRef**: `string`
...
• `Optional` **userType**: [`UserType`](../enums/types_enums.UserType.md)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_UserProfile.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_UserProfile.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_UserProfile.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_UserProfile.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_UserProfile.default.md) |
| `values` | `Object` |
...
▸ **withVersion**(`version`): [`default`](models_UserProfile.default.md)
