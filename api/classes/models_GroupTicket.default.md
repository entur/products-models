...
[models/GroupTicket](../modules/models_GroupTicket.md).default
...
• **new default**(`data?`): [`default`](models_GroupTicket.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`GroupTicketData`](../interfaces/types_interfaces.GroupTicketData.md)\> |
...
• `Optional` **groupDiscountBasis**: [`GroupDiscountBasis`](../enums/types_enums.GroupDiscountBasis.md)
...
• `Optional` **pricingBasis**: [`PerBasis`](../enums/types_enums.PerBasis.md)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_GroupTicket.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_GroupTicket.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_GroupTicket.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_GroupTicket.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_GroupTicket.default.md) |
| `values` | `Object` |
