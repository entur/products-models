[@entur-partner/products-models](../README.md) / [models/FareSection](../modules/models_FareSection.md) / default

# Class: default

[models/FareSection](../modules/models_FareSection.md).default
...
• **new default**(`data?`): [`default`](models_FareSection.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`FareSectionData`](../interfaces/types_interfaces.FareSectionData.md)\> |
...
[src/models/FareSection.ts:12](https://github.com/entur/products-models/blob/main/src/models/FareSection.ts#L12)
...
• `Optional` **fromFarePointRef**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/FareSection.ts:10](https://github.com/entur/products-models/blob/main/src/models/FareSection.ts#L10)
...
• `Optional` **journeyPatternRef**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/FareSection.ts:9](https://github.com/entur/products-models/blob/main/src/models/FareSection.ts#L9)
...
• `Optional` **toFarePointRef**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/FareSection.ts:11](https://github.com/entur/products-models/blob/main/src/models/FareSection.ts#L11)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_FareSection.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_FareSection.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_FareSection.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_FareSection.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_FareSection.default.md) |
| `values` | `Object` |
...
[src/models/FareSection.ts:20](https://github.com/entur/products-models/blob/main/src/models/FareSection.ts#L20)
