[@entur-partner/products-models](../README.md) / [models/Tariff](../modules/models_Tariff.md) / default

# Class: default

[models/Tariff](../modules/models_Tariff.md).default
...
• **new default**(`data?`): [`default`](models_Tariff.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`TariffData`](../interfaces/types_interfaces.TariffData.md)\> |
...
[src/models/Tariff.ts:14](https://github.com/entur/products-models/blob/main/src/models/Tariff.ts#L14)
...
• **tariffBasis**: [`TariffBasis`](../enums/types_enums.TariffBasis.md)

#### Defined in

[src/models/Tariff.ts:11](https://github.com/entur/products-models/blob/main/src/models/Tariff.ts#L11)

___

### validBetweenRef

• `Optional` **validBetweenRef**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/Tariff.ts:12](https://github.com/entur/products-models/blob/main/src/models/Tariff.ts#L12)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_Tariff.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_Tariff.default.md)
...
[src/models/Tariff.ts:25](https://github.com/entur/products-models/blob/main/src/models/Tariff.ts#L25)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_Tariff.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_Tariff.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_Tariff.default.md) |
| `values` | `Object` |
...
[src/models/Tariff.ts:21](https://github.com/entur/products-models/blob/main/src/models/Tariff.ts#L21)
