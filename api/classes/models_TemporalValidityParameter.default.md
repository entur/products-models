[@entur-partner/products-models](../README.md) / [models/TemporalValidityParameter](../modules/models_TemporalValidityParameter.md) / default

# Class: default

[models/TemporalValidityParameter](../modules/models_TemporalValidityParameter.md).default
...
• **new default**(`data?`): [`default`](models_TemporalValidityParameter.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`TemporalValidityParameterData`](../interfaces/types_interfaces.TemporalValidityParameterData.md)\> |
...
[src/models/TemporalValidityParameter.ts:16](https://github.com/entur/products-models/blob/main/src/models/TemporalValidityParameter.ts#L16)
...
• `Optional` **dayType**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/TemporalValidityParameter.ts:10](https://github.com/entur/products-models/blob/main/src/models/TemporalValidityParameter.ts#L10)
...
[src/models/TemporalValidityParameter.ts:14](https://github.com/entur/products-models/blob/main/src/models/TemporalValidityParameter.ts#L14)
...
• `Optional` **validityCondition**: [`default`](models_ValidityCondition.default.md)

#### Defined in

[src/models/TemporalValidityParameter.ts:11](https://github.com/entur/products-models/blob/main/src/models/TemporalValidityParameter.ts#L11)
...
[src/models/TemporalValidityParameter.ts:12](https://github.com/entur/products-models/blob/main/src/models/TemporalValidityParameter.ts#L12)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_TemporalValidityParameter.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_TemporalValidityParameter.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_TemporalValidityParameter.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_TemporalValidityParameter.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_TemporalValidityParameter.default.md) |
| `values` | `Object` |
...
[src/models/TemporalValidityParameter.ts:28](https://github.com/entur/products-models/blob/main/src/models/TemporalValidityParameter.ts#L28)
