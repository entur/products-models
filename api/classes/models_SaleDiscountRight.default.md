[@entur-partner/products-models](../README.md) / [models/SaleDiscountRight](../modules/models_SaleDiscountRight.md) / default

# Class: default

[models/SaleDiscountRight](../modules/models_SaleDiscountRight.md).default
...
• **new default**(`data?`): [`default`](models_SaleDiscountRight.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`SaleDiscountRightData`](../interfaces/types_interfaces.SaleDiscountRightData.md)\> |
...
[src/models/SaleDiscountRight.ts:19](https://github.com/entur/products-models/blob/main/src/models/SaleDiscountRight.ts#L19)
...
[src/models/SaleDiscountRight.ts:16](https://github.com/entur/products-models/blob/main/src/models/SaleDiscountRight.ts#L16)
...
[src/models/SaleDiscountRight.ts:17](https://github.com/entur/products-models/blob/main/src/models/SaleDiscountRight.ts#L17)

___

### validationRequirements

• **validationRequirements**: [`ValidationRequirementEnum`](../enums/types_enums.ValidationRequirementEnum.md)[]

#### Defined in

[src/models/SaleDiscountRight.ts:14](https://github.com/entur/products-models/blob/main/src/models/SaleDiscountRight.ts#L14)
...
[src/models/SaleDiscountRight.ts:15](https://github.com/entur/products-models/blob/main/src/models/SaleDiscountRight.ts#L15)
...
▸ **addValidableElement**(`validableElement`): [`default`](models_SaleDiscountRight.default.md)
...
▸ **changeOrderOfAccessRightsInProduct**(`accessRightInProduct`, `accessNumber`): [`default`](models_SaleDiscountRight.default.md)
...
▸ **removeValidableElementById**(`validableElementId`): [`default`](models_SaleDiscountRight.default.md)
...
▸ **setMinimumAccessForAccessRightInProduct**(`accessRightInProduct`, `minimumAccess`): [`default`](models_SaleDiscountRight.default.md)
...
[src/models/SaleDiscountRight.ts:36](https://github.com/entur/products-models/blob/main/src/models/SaleDiscountRight.ts#L36)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_SaleDiscountRight.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_SaleDiscountRight.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_SaleDiscountRight.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_SaleDiscountRight.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_SaleDiscountRight.default.md) |
| `values` | `Object` |
...
▸ **withVersion**(`version`): [`default`](models_SaleDiscountRight.default.md)
...
[src/models/SaleDiscountRight.ts:32](https://github.com/entur/products-models/blob/main/src/models/SaleDiscountRight.ts#L32)
