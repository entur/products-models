[@entur-partner/products-models](../README.md) / [models/Timeband](../modules/models_Timeband.md) / default

# Class: default

[models/Timeband](../modules/models_Timeband.md).default
...
• **new default**(`data?`): [`default`](models_Timeband.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`TimebandData`](../interfaces/types_interfaces.TimebandData.md)\> |
...
[src/models/Timeband.ts:12](https://github.com/entur/products-models/blob/main/src/models/Timeband.ts#L12)
...
[src/models/Timeband.ts:10](https://github.com/entur/products-models/blob/main/src/models/Timeband.ts#L10)
...
[src/models/Timeband.ts:9](https://github.com/entur/products-models/blob/main/src/models/Timeband.ts#L9)
...
[src/models/Timeband.ts:8](https://github.com/entur/products-models/blob/main/src/models/Timeband.ts#L8)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_Timeband.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_Timeband.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_Timeband.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_Timeband.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_Timeband.default.md) |
| `values` | `Object` |
...
[src/models/Timeband.ts:20](https://github.com/entur/products-models/blob/main/src/models/Timeband.ts#L20)
