[@entur-partner/products-models](../README.md) / [models/ServiceFacilitySet](../modules/models_ServiceFacilitySet.md) / default

# Class: default

[models/ServiceFacilitySet](../modules/models_ServiceFacilitySet.md).default
...
• **new default**(`data?`): [`default`](models_ServiceFacilitySet.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`ServiceFacilitySetData`](../interfaces/types_interfaces.ServiceFacilitySetData.md)\> |
...
[src/models/ServiceFacilitySet.ts:13](https://github.com/entur/products-models/blob/main/src/models/ServiceFacilitySet.ts#L13)

## Properties

### accommodation

• `Optional` **accommodation**: [`default`](models_Accommodation.default.md)

#### Defined in

[src/models/ServiceFacilitySet.ts:11](https://github.com/entur/products-models/blob/main/src/models/ServiceFacilitySet.ts#L11)
...
[src/models/ServiceFacilitySet.ts:27](https://github.com/entur/products-models/blob/main/src/models/ServiceFacilitySet.ts#L27)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_ServiceFacilitySet.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_ServiceFacilitySet.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_ServiceFacilitySet.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_ServiceFacilitySet.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_ServiceFacilitySet.default.md) |
| `values` | `Object` |
...
[src/models/ServiceFacilitySet.ts:21](https://github.com/entur/products-models/blob/main/src/models/ServiceFacilitySet.ts#L21)
...
[src/models/ServiceFacilitySet.ts:37](https://github.com/entur/products-models/blob/main/src/models/ServiceFacilitySet.ts#L37)
