...
[models/GeneralGroupOfEntities](../modules/models_GeneralGroupOfEntities.md).default
...
• **new default**(`data`): [`default`](models_GeneralGroupOfEntities.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`GeneralGroupOfEntitiesData`](../interfaces/types_interfaces.GeneralGroupOfEntitiesData.md)\> |
...
[src/models/GeneralGroupOfEntities.ts:12](https://github.com/entur/products-models/blob/main/src/models/GeneralGroupOfEntities.ts#L12)
...
• **members**: [`default`](models_Reference.default.md)[]

#### Defined in

[src/models/GeneralGroupOfEntities.ts:11](https://github.com/entur/products-models/blob/main/src/models/GeneralGroupOfEntities.ts#L11)
...
[src/models/GeneralGroupOfEntities.ts:10](https://github.com/entur/products-models/blob/main/src/models/GeneralGroupOfEntities.ts#L10)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_GeneralGroupOfEntities.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_GeneralGroupOfEntities.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_GeneralGroupOfEntities.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_GeneralGroupOfEntities.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_GeneralGroupOfEntities.default.md) |
| `values` | `Object` |
...
[src/models/GeneralGroupOfEntities.ts:22](https://github.com/entur/products-models/blob/main/src/models/GeneralGroupOfEntities.ts#L22)
