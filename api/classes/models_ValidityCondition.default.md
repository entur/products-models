...
[models/ValidityCondition](../modules/models_ValidityCondition.md).default
...
• **new default**(`data?`): [`default`](models_ValidityCondition.default.md)
...
[src/models/ValidityCondition.ts:8](https://github.com/entur/products-models/blob/main/src/models/ValidityCondition.ts#L8)
...
[src/models/ValidityCondition.ts:6](https://github.com/entur/products-models/blob/main/src/models/ValidityCondition.ts#L6)
...
[src/models/ValidityCondition.ts:7](https://github.com/entur/products-models/blob/main/src/models/ValidityCondition.ts#L7)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_ValidityCondition.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_ValidityCondition.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_ValidityCondition.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_ValidityCondition.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_ValidityCondition.default.md) |
| `values` | `Object` |
