...
[models/SecurityPolicy](../modules/models_SecurityPolicy.md).default
...
• **new default**(`data?`): [`default`](models_SecurityPolicy.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`SecurityPolicyData`](../interfaces/types_interfaces.SecurityPolicyData.md)\> |
...
[src/models/SecurityPolicy.ts:10](https://github.com/entur/products-models/blob/main/src/models/SecurityPolicy.ts#L10)
...
[src/models/SecurityPolicy.ts:8](https://github.com/entur/products-models/blob/main/src/models/SecurityPolicy.ts#L8)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_SecurityPolicy.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_SecurityPolicy.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_SecurityPolicy.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_SecurityPolicy.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_SecurityPolicy.default.md) |
| `values` | `Object` |
...
[src/models/SecurityPolicy.ts:16](https://github.com/entur/products-models/blob/main/src/models/SecurityPolicy.ts#L16)
