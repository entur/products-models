...
[models/Dorito](../modules/models_Dorito.md).default
...
• **new default**(`data?`): [`default`](models_Dorito.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`DoritoData`](../interfaces/types_interfaces.DoritoData.md)\> |
...
[src/models/Dorito.ts:19](https://github.com/entur/products-models/blob/main/src/models/Dorito.ts#L19)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_Dorito.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_Dorito.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_Dorito.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_Dorito.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_Dorito.default.md) |
| `values` | `Object` |
