...
[models/ChargingPolicy](../modules/models_ChargingPolicy.md).default
...
• **new default**(`data?`): [`default`](models_ChargingPolicy.default.md)
...
[src/models/ChargingPolicy.ts:8](https://github.com/entur/products-models/blob/main/src/models/ChargingPolicy.ts#L8)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_ChargingPolicy.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_ChargingPolicy.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_ChargingPolicy.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_ChargingPolicy.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_ChargingPolicy.default.md) |
| `values` | `Object` |
...
[src/models/ChargingPolicy.ts:12](https://github.com/entur/products-models/blob/main/src/models/ChargingPolicy.ts#L12)
