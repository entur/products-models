[@entur-partner/products-models](../README.md) / [models/EntitlementProduct](../modules/models_EntitlementProduct.md) / default
...
src/models/EntitlementProduct.ts:8
...
▸ **updateRefs**(`bucket`): [`default`](models_EntitlementProduct.default.md)
...
src/models/EntitlementProduct.ts:12
