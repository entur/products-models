[@entur-partner/products-models](../README.md) / [models/TypeOfResponsibilityRole](../modules/models_TypeOfResponsibilityRole.md) / default

# Class: default

[models/TypeOfResponsibilityRole](../modules/models_TypeOfResponsibilityRole.md).default
...
• **new default**(`data?`): [`default`](models_TypeOfResponsibilityRole.default.md)
...
[src/models/TypeOfResponsibilityRole.ts:8](https://github.com/entur/products-models/blob/main/src/models/TypeOfResponsibilityRole.ts#L8)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_TypeOfResponsibilityRole.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_TypeOfResponsibilityRole.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_TypeOfResponsibilityRole.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_TypeOfResponsibilityRole.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_TypeOfResponsibilityRole.default.md) |
| `values` | `Object` |
...
[src/models/TypeOfResponsibilityRole.ts:12](https://github.com/entur/products-models/blob/main/src/models/TypeOfResponsibilityRole.ts#L12)
