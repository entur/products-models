[@entur-partner/products-models](../README.md) / [models/Replacing](../modules/models_Replacing.md) / default

# Class: default

[models/Replacing](../modules/models_Replacing.md).default
...
• **new default**(`data?`): [`default`](models_Replacing.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`ReplacingData`](../interfaces/types_interfaces.ReplacingData.md)\> |
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_Replacing.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_Replacing.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_Replacing.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_Replacing.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_Replacing.default.md) |
| `values` | `Object` |
