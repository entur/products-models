...
[models/UvpForNumberOfZones](../modules/models_UvpForNumberOfZones.md).default
...
• **new default**(`data?`): [`default`](models_UvpForNumberOfZones.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`UvpForNumberOfZonesData`](../interfaces/types_interfaces.UvpForNumberOfZonesData.md)\> |
...
[src/models/UvpForNumberOfZones.ts:15](https://github.com/entur/products-models/blob/main/src/models/UvpForNumberOfZones.ts#L15)
...
[src/models/UvpForNumberOfZones.ts:10](https://github.com/entur/products-models/blob/main/src/models/UvpForNumberOfZones.ts#L10)
...
[src/models/UvpForNumberOfZones.ts:12](https://github.com/entur/products-models/blob/main/src/models/UvpForNumberOfZones.ts#L12)
...
• `Optional` **usageValidityPeriod**: [`default`](models_UsageValidityPeriod.default.md)

#### Defined in

[src/models/UvpForNumberOfZones.ts:13](https://github.com/entur/products-models/blob/main/src/models/UvpForNumberOfZones.ts#L13)
...
[src/models/UvpForNumberOfZones.ts:11](https://github.com/entur/products-models/blob/main/src/models/UvpForNumberOfZones.ts#L11)
...
[src/models/UvpForNumberOfZones.ts:47](https://github.com/entur/products-models/blob/main/src/models/UvpForNumberOfZones.ts#L47)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_UvpForNumberOfZones.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_UvpForNumberOfZones.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_UvpForNumberOfZones.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_UvpForNumberOfZones.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_UvpForNumberOfZones.default.md) |
| `values` | `Object` |
...
▸ **withVersion**(`version`): [`default`](models_UvpForNumberOfZones.default.md)
...
[src/models/UvpForNumberOfZones.ts:37](https://github.com/entur/products-models/blob/main/src/models/UvpForNumberOfZones.ts#L37)
...
[src/models/UvpForNumberOfZones.ts:33](https://github.com/entur/products-models/blob/main/src/models/UvpForNumberOfZones.ts#L33)
