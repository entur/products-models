...
[models/Reverting](../modules/models_Reverting.md).default
...
• **new default**(`data?`): [`default`](models_Reverting.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`RevertingData`](../interfaces/types_interfaces.RevertingData.md)\> |
...
[src/models/Reverting.ts:14](https://github.com/entur/products-models/blob/main/src/models/Reverting.ts#L14)
...
[src/models/Reverting.ts:9](https://github.com/entur/products-models/blob/main/src/models/Reverting.ts#L9)
...
• `Optional` **maximumTimeAfterUse**: `string`

#### Defined in

[src/models/Reverting.ts:12](https://github.com/entur/products-models/blob/main/src/models/Reverting.ts#L12)

___

### minimumTimeAfterUse

• `Optional` **minimumTimeAfterUse**: `string`

#### Defined in

[src/models/Reverting.ts:11](https://github.com/entur/products-models/blob/main/src/models/Reverting.ts#L11)
...
• `Optional` **typeOfResponsibilityRoleRef**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/Reverting.ts:10](https://github.com/entur/products-models/blob/main/src/models/Reverting.ts#L10)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_Reverting.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_Reverting.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_Reverting.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_Reverting.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_Reverting.default.md) |
| `values` | `Object` |
...
[src/models/Reverting.ts:24](https://github.com/entur/products-models/blob/main/src/models/Reverting.ts#L24)
