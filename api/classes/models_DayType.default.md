[@entur-partner/products-models](../README.md) / [models/DayType](../modules/models_DayType.md) / default

# Class: default

[models/DayType](../modules/models_DayType.md).default
...
• **new default**(`data?`): [`default`](models_DayType.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`DayTypeData`](../interfaces/types_interfaces.DayTypeData.md)\> |
...
[src/models/DayType.ts:17](https://github.com/entur/products-models/blob/main/src/models/DayType.ts#L17)

## Properties

### availabilityCondition

• `Optional` **availabilityCondition**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/DayType.ts:11](https://github.com/entur/products-models/blob/main/src/models/DayType.ts#L11)
...
• `Optional` **dayLength**: `string`

#### Defined in

[src/models/DayType.ts:12](https://github.com/entur/products-models/blob/main/src/models/DayType.ts#L12)
...
• `Optional` **durationAfterPropertiesOfDay**: `string`

#### Defined in

[src/models/DayType.ts:14](https://github.com/entur/products-models/blob/main/src/models/DayType.ts#L14)

___

### durationBeforePropertiesOfDay

• `Optional` **durationBeforePropertiesOfDay**: `string`

#### Defined in

[src/models/DayType.ts:13](https://github.com/entur/products-models/blob/main/src/models/DayType.ts#L13)

___

### earliestTime

• `Optional` **earliestTime**: `string`

#### Defined in

[src/models/DayType.ts:10](https://github.com/entur/products-models/blob/main/src/models/DayType.ts#L10)
...
• `Optional` **properties**: [`default`](models_PropertyOfDay.default.md)[]

#### Defined in

[src/models/DayType.ts:15](https://github.com/entur/products-models/blob/main/src/models/DayType.ts#L15)
...
[src/models/DayType.ts:16](https://github.com/entur/products-models/blob/main/src/models/DayType.ts#L16)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_DayType.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_DayType.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_DayType.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_DayType.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_DayType.default.md) |
| `values` | `Object` |
...
[src/models/DayType.ts:43](https://github.com/entur/products-models/blob/main/src/models/DayType.ts#L43)
