...
[models/LimitingRule](../modules/models_LimitingRule.md).default
...
• **new default**(`data`): [`default`](models_LimitingRule.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`LimitingRuleData`](../interfaces/types_interfaces.LimitingRuleData.md)\> |
...
[src/models/LimitingRule.ts:16](https://github.com/entur/products-models/blob/main/src/models/LimitingRule.ts#L16)

## Properties

### canBeCumulative

• `Optional` **canBeCumulative**: `boolean`

#### Defined in

[src/models/LimitingRule.ts:8](https://github.com/entur/products-models/blob/main/src/models/LimitingRule.ts#L8)
...
• `Optional` **discountAsPercentage**: `number`

#### Defined in

[src/models/LimitingRule.ts:9](https://github.com/entur/products-models/blob/main/src/models/LimitingRule.ts#L9)

___

### discountAsValue

• `Optional` **discountAsValue**: `number`

#### Defined in

[src/models/LimitingRule.ts:10](https://github.com/entur/products-models/blob/main/src/models/LimitingRule.ts#L10)
...
• `Optional` **maximumPrice**: `string`

#### Defined in

[src/models/LimitingRule.ts:12](https://github.com/entur/products-models/blob/main/src/models/LimitingRule.ts#L12)

___

### maximumPriceAsPercentage

• `Optional` **maximumPriceAsPercentage**: `string`

#### Defined in

[src/models/LimitingRule.ts:11](https://github.com/entur/products-models/blob/main/src/models/LimitingRule.ts#L11)

___

### minimumLimitPrice

• `Optional` **minimumLimitPrice**: `string`

#### Defined in

[src/models/LimitingRule.ts:14](https://github.com/entur/products-models/blob/main/src/models/LimitingRule.ts#L14)

___

### minimumPrice

• `Optional` **minimumPrice**: `string`

#### Defined in

[src/models/LimitingRule.ts:13](https://github.com/entur/products-models/blob/main/src/models/LimitingRule.ts#L13)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_LimitingRule.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_LimitingRule.default.md)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_LimitingRule.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_LimitingRule.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_LimitingRule.default.md) |
| `values` | `Object` |
...
[src/models/LimitingRule.ts:28](https://github.com/entur/products-models/blob/main/src/models/LimitingRule.ts#L28)
