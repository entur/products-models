[@entur-partner/products-models](../README.md) / [models/SalesPackageElement](../modules/models_SalesPackageElement.md) / default

# Class: default

[models/SalesPackageElement](../modules/models_SalesPackageElement.md).default
...
• **new default**(`data?`): [`default`](models_SalesPackageElement.default.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | `Partial`\<[`SalesPackageElementData`](../interfaces/types_interfaces.SalesPackageElementData.md)\> |
...
[src/models/SalesPackageElement.ts:14](https://github.com/entur/products-models/blob/main/src/models/SalesPackageElement.ts#L14)
...
• `Optional` **fareProductRef**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/SalesPackageElement.ts:10](https://github.com/entur/products-models/blob/main/src/models/SalesPackageElement.ts#L10)
...
[src/models/SalesPackageElement.ts:12](https://github.com/entur/products-models/blob/main/src/models/SalesPackageElement.ts#L12)
...
• `Optional` **salesPackageRef**: [`default`](models_Reference.default.md)

#### Defined in

[src/models/SalesPackageElement.ts:11](https://github.com/entur/products-models/blob/main/src/models/SalesPackageElement.ts#L11)
...
| Name | Type |
| :------ | :------ |
| `refProp` | keyof [`default`](models_SalesPackageElement.default.md) |
...
▸ **updateRefs**(`bucket`): [`default`](models_SalesPackageElement.default.md)
...
[src/models/SalesPackageElement.ts:34](https://github.com/entur/products-models/blob/main/src/models/SalesPackageElement.ts#L34)
...
| Name | Type |
| :------ | :------ |
| `property` | keyof [`default`](models_SalesPackageElement.default.md) |
| `args` | `object` |
...
| Name | Type |
| :------ | :------ |
| `fieldName` | keyof [`default`](models_SalesPackageElement.default.md) |
| `lang` | `string` |
| `value` | `string` |
...
| Name | Type |
| :------ | :------ |
| `field` | keyof [`default`](models_SalesPackageElement.default.md) |
| `values` | `Object` |
...
[src/models/SalesPackageElement.ts:30](https://github.com/entur/products-models/blob/main/src/models/SalesPackageElement.ts#L30)
