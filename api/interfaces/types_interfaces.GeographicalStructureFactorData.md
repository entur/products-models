[@entur/products-models](../README.md) / [types/interfaces](../modules/types_interfaces.md) / GeographicalStructureFactorData

# Interface: GeographicalStructureFactorData

[types/interfaces](../modules/types_interfaces.md).GeographicalStructureFactorData
...
• **distanceMatrixElements**: [`default`](../classes/models_DistanceMatrixElement.default.md)[]

#### Defined in

[src/types/interfaces.ts:624](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L624)

___

### geographicalIntervals

• **geographicalIntervals**: [`default`](../classes/models_GeographicalInterval.default.md)[]

#### Defined in

[src/types/interfaces.ts:623](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L623)
