[@entur-partner/products-models](../README.md) / [types/interfaces](../modules/types_interfaces.md) / CellData

# Interface: CellData

[types/interfaces](../modules/types_interfaces.md).CellData
...
• **farePrice**: [`default`](../classes/models_FarePrice.default.md)

#### Defined in

[src/types/interfaces.ts:735](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L735)
...
• **priceableObjectRefs**: [`default`](../classes/models_Reference.default.md)[]

#### Defined in

[src/types/interfaces.ts:734](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L734)
