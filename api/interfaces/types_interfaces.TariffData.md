[@entur-partner/products-models](../README.md) / [types/interfaces](../modules/types_interfaces.md) / TariffData

# Interface: TariffData

[types/interfaces](../modules/types_interfaces.md).TariffData
...
[src/types/interfaces.ts:373](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L373)

___

### validBetweenRef

• **validBetweenRef**: [`default`](../classes/models_Reference.default.md)

#### Defined in

[src/types/interfaces.ts:374](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L374)
