[@entur-partner/products-models](../README.md) / [types/interfaces](../modules/types_interfaces.md) / SalesPackageElementData

# Interface: SalesPackageElementData

[types/interfaces](../modules/types_interfaces.md).SalesPackageElementData
...
• **fareProductRef**: [`default`](../classes/models_Reference.default.md)

#### Defined in

[src/types/interfaces.ts:326](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L326)
...
[src/types/interfaces.ts:328](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L328)
...
[src/types/interfaces.ts:327](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L327)
