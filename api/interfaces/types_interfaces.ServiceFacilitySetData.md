[@entur-partner/products-models](../README.md) / [types/interfaces](../modules/types_interfaces.md) / ServiceFacilitySetData

# Interface: ServiceFacilitySetData

[types/interfaces](../modules/types_interfaces.md).ServiceFacilitySetData
...
• `Optional` **accommodation**: [`default`](../classes/models_Accommodation.default.md)

#### Defined in

[src/types/interfaces.ts:354](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L354)
