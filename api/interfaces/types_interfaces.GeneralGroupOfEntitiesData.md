[@entur-partner/products-models](../README.md) / [types/interfaces](../modules/types_interfaces.md) / GeneralGroupOfEntitiesData

# Interface: GeneralGroupOfEntitiesData

[types/interfaces](../modules/types_interfaces.md).GeneralGroupOfEntitiesData
...
• **members**: [`default`](../classes/models_Reference.default.md)[]

#### Defined in

[src/types/interfaces.ts:649](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L649)
...
[src/types/interfaces.ts:648](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L648)
