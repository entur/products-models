[@entur-partner/products-models](../README.md) / [types/interfaces](../modules/types_interfaces.md) / EntitlementGivenData

# Interface: EntitlementGivenData

[types/interfaces](../modules/types_interfaces.md).EntitlementGivenData
...
[src/types/interfaces.ts:259](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L259)
...
[src/types/interfaces.ts:261](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L261)
...
[src/types/interfaces.ts:262](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L262)

___

### serviceAccessRightRef

• **serviceAccessRightRef**: [`default`](../classes/models_Reference.default.md)

#### Defined in

[src/types/interfaces.ts:260](https://github.com/entur/products-models/blob/main/src/types/interfaces.ts#L260)
